...
%    }
    ...
    Отношение находится в 4НФ, если оно уже находится в НФБК и не содержит нетривиальных многозначных зависимостей. Для моей модели это уже выполняется
    ...
    \Section{Вывод}
        При выполнении лабораторной работы я познакомился с методами нормализации и денормализации баз данных, научился создавать тригеры с функции в PL/pgSQL.
    \newpage
