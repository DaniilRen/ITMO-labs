...
%    }
    ...
    Отношение находится в НФБК, если оно уже находится в 3НФ и для всех функиональных зависимостей отношения выолняется условие: детерминант - потенциальный ключ. Для моей модели это уже выполняется
