...
\newcommand{\variant}{№ 83574}                % номер варианта работы
...
%>>>>>>>>>>>>>>>>>>>'''''''''''''''''>>>>>>>>>>>>>>>>>>>>>
    ...
    \begin{itemize}
        ...
        \item Для обмена данными на сервере необходимо использовать потоки ввода-вывода
   ...
   Реализовать логирование различных этапов работы сервера (начало работы, получение нового подключения, получение нового запроса, отправка ответа и т.п.) с помощью Log4J2
    ...
    \url{https://github.com/DaniilRen/ITMO-labs/tree/main/Java/labs/Lab6}
    ...
    Ссылка на диаграмму: \url{https://github.com/DaniilRen/ITMO-labs/blob/main/Java/labs/Lab6/docs/assets/Lab6.png}
    ...
    \Section{Вывод}
     Во время выполнения лабораторной работы я изучил передачу данных при помощи протокола TCP, принципы построения клиент-серверного приложения и организацию взаимодействия между ними.
    \newpage
%<<<<<<<<<<<<<<<<<<<<<< КОД РАБОТЫ <<<<<<<<<<<<<<<<<<<<<<<<
