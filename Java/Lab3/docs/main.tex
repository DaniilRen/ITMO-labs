...
Задание было выполнено в редакторе кода Visual Studio Code, собрано в \verb|jar| файл \verb|lab3.jar| и загружено в Git репозиторий на GitHub.
...
% Выполнение задания...
    ...
    ракета мчалась со страшный скоростью  покрывая пространство в двенадцать километров в одну секунду
    Незнайка думал что ракета застыла на месте и ни на пол пальца приближается к Луна
    Это объяснялось тем, что расстояние от Луна до Земля очень большое -- около четыреста тысяч километров
    При таком огромное расстоянии скорость двенадцать километров в одну секунду не так велико чтоб ее можно было было заметить на глаз, да еще и находясь в ракета
    прошло два часа или прошло три часа
    Незнайка смотрел на Planet[name=Луна]
    не мог оторваться
    мог оторваться
    Луна притягивала к себе взоры Незнайка
    Незнайка почуствовал какое-то мучительное посасывание в животе
    Незнайка сообразил что наступила пора обедать
    Незнайка спустился в пищевой отсек
    Незнайка увидел что Пончик уже проснулся
    Незнайка увидел что Пончик уже что-то жует с с аппетитом
    \end{lstlisting}
