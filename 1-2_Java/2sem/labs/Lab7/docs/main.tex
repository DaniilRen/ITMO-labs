...
\newcommand{\variant}{№ 3903}                % номер варианта работы
...
%>>>>>>>>>>>>>>>>>>>'''''''''''''''''>>>>>>>>>>>>>>>>>>>>>
    ...
    \begin{enumerate}
        ...
        \item При хранении объектов сохранять инфДля идентификации пользователя отправлять логин и пароль с каждым запросомормацию о пользователе, который создал этот объект.
    ...
    \begin{enumerate}
        ...
        \item Для многопотчной обработки полученного запроса использовать Fixed thread pool
    ...
    \url{https://github.com/DaniilRen/ITMO-labs/tree/main/Java/labs/Lab7}
    ...
    Ссылка на диаграмму: \url{https://github.com/DaniilRen/ITMO-labs/blob/main/Java/labs/Lab6/docs/assets/Lab7.png}
