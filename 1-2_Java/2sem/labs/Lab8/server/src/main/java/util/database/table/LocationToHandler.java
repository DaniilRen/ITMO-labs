 ...
 * @author Septyq
 */
public class LocationToHandler extends TableHandler<LocationTo> {
    public LocationToHandler(Connection connection) {
        super(connection);
    }

    @Override
    public int getId(LocationTo object) {
    ...
    @Override
    public int insert(LocationTo object) throws SQLException {
