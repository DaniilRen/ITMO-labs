...
Задание было выполнено в редакторе кода Visual Studio Code, собрано в \verb|jar| файл \verb|lab3.jar| и загружено в Git репозиторий на GitHub \cite{github}.
    ...
    \begin{figure}[H] % 'H' -- вставить тут же (подключен модуль), обычный вариант: 'htpb'
        \centering
        \includegraphics[width=\textwidth*1/2]{Lab5.png}
        \caption{UML диаграмма}
        \label{fig:diagr}
    \end{figure}

    Ссылка на диаграмму: \url{https://github.com/DaniilRen/ITMO-labs/blob/main/Java/labs/Lab5/docs/assets/Lab5.png}

    % \newpage

    \Subsection{Упрощенная архитектурная схема}
