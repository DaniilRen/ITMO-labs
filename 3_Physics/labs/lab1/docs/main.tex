...
\begin{itemize}
    \item Проведены вычисления относительных отклонений экспериментальной вероятности от теоретической для стандартных интервалов.
    
    1) Для интервала \(\langle h \rangle_N \pm \sigma_N\)
    \[
    \Delta_1 = \frac{0.78 - 0.683}{0.683} \cdot 100\% = 14.20\%
    \]
    
    2) Для интервала \(\langle h \rangle_N \pm 2\sigma_N\)
    \[
    \Delta_2 = \frac{1.00 - 0.954}{0.954} \cdot 100\% = 4.82\%
    \]
    
    3) Для интервала \(\langle h \rangle_N \pm 3\sigma_N\)
    \[
    \Delta_3 = \frac{1.00 - 0.997}{0.997} \cdot 100\% = 0.30\%
    \]
...
\[
h = (280,26 \pm 14,56) \text{ мс}; \quad \delta = 5,20\%; \quad N = 50; \quad \alpha = 0,95
\]
