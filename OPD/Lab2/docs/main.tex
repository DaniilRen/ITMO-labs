...
%    }
    ...
    \begin{tabularx}{\textwidth}{|c|c|c|X|}
        ...
        \hline
        177 & 2182 & - & Промежуточный результат P \\
        \hline
        178 & 0200 & CLA & Очистить аккумулятор \newline AC $\to$ 0 \\
        \hline
        179 & 0280 & NOT & Инвертировать аккумулятор \newline (\^{}AC) $\to$ AC \\
        \hline
        17A & 2182 & AND 182 & AC $\&$ D $\to$ AC \\
        \hline
        17B & 3181 & OR 181 & AC $\|$ C $\to$ AC \\
        \hline
        17C & E177 & ST 177 & AC $\to$ P \\
        \hline
        17D & A183 & LD 183 & E $\to$ AC \\
        \hline
        17E & 4177 & ADD 177 & AC + P $\to$ AC \\
        \hline
...
\begin{itemize}
    \item P = (1111.1111.1111.1111 $\&$ D) $\|$ C = D $\|$ C
    \item R = P + E = (1111.1111.1111.1111 $\&$ D) $\|$ C + E = D $\|$ C + E
\end{itemize}
\noindent
