...
\begin{itemize}
    ...
    \item 300-304 (элементы массива),  2ED (результат) - 16-ти разрядные знаковое целые числа
\end{itemize}

\textbf{Область допустимых значений}
\begin{itemize}
    \item 2EA (длина массива) $\in$ [0; 1280]
    \item 2EB (результат) $\in$ [$-2^{15}$; $2^{15}-1$]
    \item 2EC (первый элемент) $\in$ [0; 2EA-длина массива] $\lor$ [2FF; 7FF-длина массива]
    \item 2ED (текущий элемент) $\in$ [первый элемент; первый элемент + длина массива - 1]
