...
%    }
    ...
    \Subsection{Дополнительные задание 1}
		...
		Результат: \ref{lst:ron1}

		\lstinputlisting[caption={самописная сериализация},label={lst:ron1}]{../src/output/schedule_hand_written.ron}		
	...
	\Subsection{Дополнительные задание 2}
		...
		Результат моего алгоритма: \ref{lst:ron1}	

		Результат с использованием библиотек: \ref{lst:ron2}

		\lstinputlisting[caption={сериализация через библиотеки},label={lst:ron2}]{../src/output/schedule_advanced.ron}	
		...
		\begin{figure}[H]
			...
			\caption{самописная сериализация}
			\label{fig:hand}
    \end{figure}
		...
		\begin{figure}[H]
			...
			\caption{с использованием библиотек}
			\label{fig:auto}
    \end{figure}
    ...
    \Subsection{Дополнительные задание 3}
		...
		Результат: \ref{lst:xml}

		\lstinputlisting[caption={самописная сериализация},label={lst:xml}]{../src/output/schedule_hand_written.xml}	
