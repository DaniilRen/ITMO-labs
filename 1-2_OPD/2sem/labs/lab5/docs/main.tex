...
\hline
\rowcolor{softblue}
2DC & F0FD & BEQ IP-3 & Если нет, переход в 2D9 (Spin loop)\\
\hline
\rowcolor{softgreen}
...
\hline
\rowcolor{softgreen}
2E0 & F0FE & BEQ IP+15 & Если стоп-слово, выход\\
\hline
\rowcolor{softblue}
...
\hline
\rowcolor{softblue}
2E4 & F0FD & BEQ IP-3 & Если нет, переход в 2D9 (Spin loop)\\
\hline
\rowcolor{softgreen}
2E5 & 1206 & IN 6 & Чтени DR ВУ-3\\
\hline
\rowcolor{softgreen}
2E6 & 0680 & SWAB & Обмен старшего и младшего байтов AC\\
\hline
\rowcolor{softgreen}
2E7 & 3EEF & OR IP-17 & OR с предыдущим значением\\
\hline
\rowcolor{softgreen}
2E8 & EAF9 & ST (IP-20)+ & Сохранение результата\\
\hline
\rowcolor{yellow}
